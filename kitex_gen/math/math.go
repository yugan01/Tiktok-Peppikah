...
func (p *DivideRequest) InitDefault() {
	*p = DivideRequest{}
}
...
func (p *DivideRequest) SetFirst(val float64) {
	p.First = val
}
func (p *DivideRequest) SetSecond(val float64) {
	p.Second = val
}
...
func (p *DivideRequest) DeepEqual(ano *DivideRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *DivideRequest) Field1DeepEqual(src float64) bool {
...
func (p *DivideRequest) Field2DeepEqual(src float64) bool {
...
type DivideResponse struct {
	Divideresult float64 `thrift:"divideresult,1" frugal:"1,default,double" json:"divideresult"`
}
...
func (p *DivideResponse) InitDefault() {
	*p = DivideResponse{}
}
...
func (p *DivideResponse) SetDivideresult(val float64) {
	p.Divideresult = val
}
...
func (p *DivideResponse) DeepEqual(ano *DivideResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	}
	if !p.Field1DeepEqual(ano.Divideresult) {
		return false
	}
	return true
}

func (p *DivideResponse) Field1DeepEqual(src float64) bool {

	if p.Divideresult != src {
		return false
	}
	return true
}
...
func (p *MathSvcAddArgs) InitDefault() {
	*p = MathSvcAddArgs{}
}
...
func (p *MathSvcAddArgs) SetReq(val *AddRequest) {
	p.Req = val
}
...
func (p *MathSvcAddArgs) DeepEqual(ano *MathSvcAddArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MathSvcAddArgs) Field1DeepEqual(src *AddRequest) bool {
...
func (p *MathSvcAddResult) InitDefault() {
	*p = MathSvcAddResult{}
}
...
func (p *MathSvcAddResult) SetSuccess(x interface{}) {
...
func (p *MathSvcAddResult) DeepEqual(ano *MathSvcAddResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MathSvcAddResult) Field0DeepEqual(src *AddResponse) bool {
...
func (p *MathSvcSubtractArgs) InitDefault() {
	*p = MathSvcSubtractArgs{}
}
...
func (p *MathSvcSubtractArgs) SetReq(val *SubtractRequest) {
	p.Req = val
}
...
func (p *MathSvcSubtractArgs) DeepEqual(ano *MathSvcSubtractArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MathSvcSubtractArgs) Field1DeepEqual(src *SubtractRequest) bool {
...
func (p *MathSvcSubtractResult) InitDefault() {
	*p = MathSvcSubtractResult{}
}
...
func (p *MathSvcSubtractResult) SetSuccess(x interface{}) {
...
func (p *MathSvcSubtractResult) DeepEqual(ano *MathSvcSubtractResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MathSvcSubtractResult) Field0DeepEqual(src *SubtractResponse) bool {
...
func (p *MathSvcMultiplyArgs) InitDefault() {
	*p = MathSvcMultiplyArgs{}
}
...
func (p *MathSvcMultiplyArgs) SetReq(val *MultiplyRequest) {
	p.Req = val
}
...
func (p *MathSvcMultiplyArgs) DeepEqual(ano *MathSvcMultiplyArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MathSvcMultiplyArgs) Field1DeepEqual(src *MultiplyRequest) bool {
...
func (p *MathSvcMultiplyResult) InitDefault() {
	*p = MathSvcMultiplyResult{}
}
...
func (p *MathSvcMultiplyResult) SetSuccess(x interface{}) {
...
func (p *MathSvcMultiplyResult) DeepEqual(ano *MathSvcMultiplyResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MathSvcMultiplyResult) Field0DeepEqual(src *MultiplyResponse) bool {
...
type MathSvcDivideArgs struct {
	Req *DivideRequest `thrift:"req,1" frugal:"1,default,DivideRequest" json:"req"`
}
...
func (p *MathSvcDivideArgs) InitDefault() {
	*p = MathSvcDivideArgs{}
}
...
func (p *MathSvcDivideArgs) SetReq(val *DivideRequest) {
	p.Req = val
}
...
func (p *MathSvcDivideArgs) DeepEqual(ano *MathSvcDivideArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MathSvcDivideArgs) Field1DeepEqual(src *DivideRequest) bool {
...
type MathSvcDivideResult struct {
	Success *DivideResponse `thrift:"success,0,optional" frugal:"0,optional,DivideResponse" json:"success,omitempty"`
}
...
func (p *MathSvcDivideResult) InitDefault() {
	*p = MathSvcDivideResult{}
}
...
func (p *MathSvcDivideResult) SetSuccess(x interface{}) {
	p.Success = x.(*DivideResponse)
}
...
func (p *MathSvcDivideResult) DeepEqual(ano *MathSvcDivideResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MathSvcDivideResult) Field0DeepEqual(src *DivideResponse) bool {
